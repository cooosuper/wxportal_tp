			...
			<tr>
				...
				<td colspan="3" valign="top">
					...
					<center><font color="red" id="tip">&nbsp;</font></center>
		 			<form action="<?php echo U($group_name . '/FunctionManage/doEditNewsResp');?>" method="post" enctype="multipart/form-data">
						<table>
							<tr>
								<td>关键字</td>
								<td>
							...
							<tr>
								<td>标题1</td>
								<td><input name="title1" id="title1" value="<?php echo ($curNews[0]["title"]); ?>"/></td>
							</tr>
							<tr>
								<td>简介1</td>
								<td><input name="description1" id="description1" value="<?php echo ($curNews[0]["description"]); ?>"/></td>
							</tr>
							<tr>
								<td>上传图片1</td>
								<td><input type="file"  name="pic1" id="pic1" value="请重新选择图片"></td>
							</tr>
							<tr>
								<td>跳转地址1</td>
								<td><input name="url1" id="url1" value="<?php echo ($curNews[0]["url"]); ?>"/></td>
							</tr>
							<tr>
								<td>标题2</td>
								<td><input name="title2" id="title2" value="<?php echo ($curNews[1]["title"]); ?>"/></td>
							</tr>
							<tr>
								<td>简介2</td>
								<td><input name="description2" id="description2" value="<?php echo ($curNews[1]["description"]); ?>"/></td>
							</tr>
							<tr>
								<td>上传图片2</td>
							...
							<tr>
								<td>跳转地址2</td>
								<td><input name="url2" id="url2" value="<?php echo ($curNews[1]["url"]); ?>"/></td>
							</tr>
							<tr>
								<td>标题3</td>
								<td><input name="title3" id="title3" value="<?php echo ($curNews[2]["title"]); ?>"/></td>
							</tr>
							<tr>
								<td>简介3</td>
								<td><input name="description3" id="description3" value="<?php echo ($curNews[2]["description"]); ?>"/></td>
							</tr>
							<tr>
								<td>上传图片3</td>
							...
							<tr>
								<td>跳转地址3</td>
								<td><input name="url3" id="url3" value="<?php echo ($curNews[2]["url"]); ?>"/></td>
							</tr>
							<tr>
								<td>标题4</td>
								<td><input name="title4" id="title4" value="<?php echo ($curNews[3]["title"]); ?>"/></td>
							</tr>
							<tr>
								<td>简介4</td>
								<td><input name="description4" id="description4" value="<?php echo ($curNews[3]["description"]); ?>"/></td>
							</tr>
							<tr>
								<td>上传图片4</td>
							...
							<tr>
								<td>跳转地址4</td>
								<td><input name="url4" id="url4" value="<?php echo ($curNews[3]["url"]); ?>"/></td>
							</tr>
							<tr>
