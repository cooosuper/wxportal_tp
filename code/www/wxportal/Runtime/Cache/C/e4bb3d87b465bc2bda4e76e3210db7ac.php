...
<div id="page_container">
	<div id="page_menu">
    	<ul>
            <li><a href="<?php echo U('C/Index/index');?>" class="current">Home</a></li>
            <li><a href="<?php echo U('C/Index/subpage');?>">Search</a></li>
    ...
    <div id="templatemo_content">
        ...
        <div id="templatemo_content_right">
        	<div class="templatemo_product_box">
   	      ...
   	      <img src="../Public/images/templatemo_image_01.jpg" alt="image" />
            ...
            <div class="templatemo_product_box">
       	    ...
       	    <img src="../Public/images/templatemo_image_02.jpg" alt="image" />
                <div class="product_info">
            ...
            <div class="templatemo_product_box">
   	      ...
   	      <img src="../Public/images/templatemo_image_03.jpg" alt="image" />
                <div class="product_info">
            ...
            <div class="templatemo_product_box">
            	...
            	<img src="../Public/images/templatemo_image_04.jpg" alt="image" />
                <div class="product_info">
